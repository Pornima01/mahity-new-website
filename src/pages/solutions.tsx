  ...
  const solutions: Solution[] = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: "High-performance architecture blueprints",
          icon: "architecture",
        },
        {
        ...
        },
        {
          ...
          description: "Reduce cloud spend by up to 60%",
          icon: "savings",
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: "24/7 system health monitoring",
          icon: "monitor_heart",
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: "Streaming data and instant insights",
          icon: "speed",
        },
        {
          title: "ETL/ELT Solutions",
          description: "Extract, transform, and load automation",
          icon: "transform",
        },
        {
          title: "Data Lake Architecture",
          description: "Centralized data repository design",
          icon: "water_drop",
        },
        {
          title: "BI & Visualization",
          description: "Tableau, PowerBI, and Looker",
          icon: "insights",
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: "SOC 2, HIPAA, GDPR compliance",
          icon: "gavel",
        },
        {
...
<AnimatePresence>
  {expandedPillar === solution.id && (
    ...
    >
      {/* Top Horizontal Line connecting all services */}
      <motion.div 
        className="hidden lg:block absolute top-0 left-[16.666%] right-[16.666%] h-0.5 bg-gradient-to-r from-transparent via-primary/50 to-transparent"
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
        transition={{ delay: 0.2, duration: 0.5 }}
      />

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 relative pt-0 lg:pt-4">
        {solution.services.map((service, serviceIndex) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
            transition={{ delay: 0.1 + serviceIndex * 0.08, duration: 0.4 }}
          >
            ...
            <motion.div 
              ...
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
              transition={{ delay: 0.3 + serviceIndex * 0.05, duration: 0.3 }}
              style={{ originY: 0 }}
            />
            ...
            >
              ...
              <div className="relative glass-card rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-primary/50 transition-all h-full flex flex-col">
                ...
                {/* Link */}
                <a
                  href={`/services/${solution.id}/${service.title.toLowerCase().replace(/\s+/g, "-").replace(/&/g, "and")}`}
